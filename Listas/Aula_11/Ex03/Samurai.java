/**
 * This class represents a Samurai warrior in the game. It is an extension of the 
...
public class Samurai extends Characters{
	...
	/**
	 * Creates a samurai for the game.
	 ...
	 */
	public Samurai(double hp, double strength, double defense, double ado, String id){
